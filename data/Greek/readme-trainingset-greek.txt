...
The file offenseval-greek-training-v1.tsv contains 10,287 annotated tweets. 

The file offenseval-annotation.txt contains a short summary of the annotation guidelines.

Twitter user mentions were substituted by @USER and URLs have been removed.

Each instance contains up to 1 labels corresponding to the following sub-task:
